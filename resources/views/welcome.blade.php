            ...
            <div class="container mx-auto mx-auto p-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-4">
                    <div class="bg-white rounded-lg border p-4">
                        ...
                        <div class="px-1 py-4">
                            <div class="font-bold text-xl mb-2">“Learn Together With Your Peers”</div>
                            <p class="text-gray-700 text-base">
                                Pandai mendorong siswa berpartisipasi aktif dan berbagi pengetahuan.
                            </p>
                        </div>
                    </div>
                    <div class="bg-white rounded-lg border p-4">
                        <img src="https://placehold.co/300x200/d1d4ff/352cb5.png" alt="Placeholder Image" class="w-full h-48 rounded-md object-cover">
                        <div class="px-1 py-4">
                            <div class="font-bold text-xl mb-2">"Unlock Knowledge, Earn Tokens!"</div>
                            <p class="text-gray-700 text-base">
                                Pandai mendorong siswa berpartisipasi aktif dan berbagi pengetahuan dengan insentif token, memupuk budaya kolaborasi dalam komunitas belajar.
                            </p>
                        </div>
                    </div>
                    <div class="bg-white rounded-lg border p-4">
                        <img src="https://placehold.co/300x200/d1d4ff/352cb5.png" alt="Placeholder Image" class="w-full h-48 rounded-md object-cover">
                        <div class="px-1 py-4">
                            <div class="font-bold text-xl mb-2">“Specialized Content”</div>
                            <p class="text-gray-700 text-base">
                                Konten yang kami sediakan ditujukan khusus untuk anda pada jenjang pendidikan yang lebih tinggi.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
                <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                    ...
                    <div class="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
                        <span class="block text-gray-300">We change the way UI components libraries are used</span>

                        <span class="block text-gray-300">Tailus Blocks &copy; 2023</span>
